...
Phase 1 Static Portfolio MVP를 확장하고, LLM Wiki 기반 지식 관리 흐름을 준비한다.
...
- [ ] raw source 관리 기준 확정
- [ ] 공개/비공개 정보 기준 재확인
- [ ] Ask About Me 답변 기준 확정
- [ ] Wiki lint 체크리스트 작성

## Next Recommended Step

다음 작업은 `content/wiki/index.md`와 `content/wiki/log.md`를 만들고, 새 자료를 Wiki에 반영하는 ingest workflow를 정리하는 것이다.
